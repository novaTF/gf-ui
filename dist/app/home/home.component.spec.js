...
testing_1.describe('Component: Home', function () {
    ...
    testing_1.it('should create the component', testing_1.inject([], function () {
        return builder.createAsync(HomeComponentTestController)
            ...
            var query = fixture.debugElement.query(platform_browser_1.By.directive(home_component_1.HomeComponent));
            testing_1.expect(query).toBeTruthy();
            testing_1.expect(query.componentInstance).toBeTruthy();
        });
    }));
});
var HomeComponentTestController = (function () {
    function HomeComponentTestController() {
    }
    HomeComponentTestController = __decorate([
        core_1.Component({
            selector: 'test',
            template: "\n    <app-home></app-home>\n  ",
    ...
    ], HomeComponentTestController);
    return HomeComponentTestController;
}());
